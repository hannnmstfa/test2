	...
	<nav class="navbar">
		...
		<div>
			<ul>
				...
				<span><a href="deterjen.php" class="spesial-hvr">Deterjen</a></span>
...
<body>
	 <div class="container-item">
		...
		$query = "SELECT nama, foto, ukuran,stok, harga FROM produk WHERE nama LIKE '%Deterjen%'";
        ...
        ?>
	        ...
	        <div class="item">
	        	<div class="item-container">
	        		<img class="produk" src="fotoproduk/<?php echo $row["foto"]; ?>" width="100%">
	        	</div>
	        	<p class="p-sps"><?php echo $row["nama"]; ?></p>
	        	<p class="p-sps1">Ukuran <?php echo $row["ukuran"]; ?></p>
	        	<p class="p-sps1">Stok <?php echo $row["stok"]; ?></p>
	        	<p class="p-sps" style="font-size: 13px; margin: 0;">Rp <?php echo $row["harga"]; ?></p>
	        	<div class="beli-cnt">
