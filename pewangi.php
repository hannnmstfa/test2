	...
	<nav class="navbar">
		...
		<div>
			<ul>
				...
				<span><a href="pewangi.php" class="spesial-hvr">Pewangi</a></span>
			</ul>
		</div>
		<div class="btn-nav">
			<a href="login.php">
...
<body>
	<div class="container-item">
		...
		$query = "SELECT nama, foto, ukuran,stok, harga FROM produk WHERE nama LIKE '%Setrika%' OR nama LIKE '%Parfum%' OR nama LIKE'%Softener%'";
		...
		<div class="item">
			...
			<!-- <p class="p-sps1" >Berminat? <a style="text-decoration: underline;" href="http://wa.me/<?php echo $pemilik['wa'] ?>" target="_blank">Hubungi Admin</a></p> -->
			<div class="beli-cnt">
