	...
	<nav class="navbar">
		...
		<div>
			<ul>
				...
				<span><a href="karbol.php" class="spesial-hvr">Karbol</a></span>
...
<body>
	 <div class="container-item">
		...
		$query = "SELECT nama, foto, ukuran,stok, harga FROM produk WHERE nama LIKE '%Karbol%'";
